      ...
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 ">
        ...
        <div>
          ...
          <p className="text-gray-500 text-xl">
            Se você quiser conhecer mais sobre mim ou se você apenas
            <br />
            gostaria de dizer olá, manda-me uma mensagem. Eu adoraria ler algo de você.
          </p>
        </div>
            ...
            <form>
              ...
              <div className="flex justify-between ">
                <div className="underline">
                  <a href="mailto:parthurx@hotmail.com">
                  Envie-me um e-mail diretamente
                  </a>
                </div>
                <button className="bg-indigo-500 text-white px-4 py-2 w-40 rounded-md hover:bg-indigo-400">
                  <a href="mailto:parthurx@hotmail.com">Enviar</a>
                </button>
              </div>
            </form>
          </div>
